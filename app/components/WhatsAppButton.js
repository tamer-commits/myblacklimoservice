...
export default function WhatsAppButton() {
  const phoneNumber = '61420770707';
  const message =
    "Hi, I'd like to enquire about booking a chauffeur ride with My Black Limo Service.";
  ...
  return (
    <a
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 6px 20px rgba(0,0,0,.55)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = 'scale(1)';
        e.currentTarget.style.boxShadow = '0 4px 16px rgba(0,0,0,.45)';
      }}
    >
      <svg
        width="26"

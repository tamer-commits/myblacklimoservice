...
export async function ensureSchema(){
 ...
 schemaReady = (async () => {
  ...
  // 'web' (default, backward compatible) | 'whatsapp' — lets the admin UI
  // and reports tell a WhatsApp intake-bot booking apart from a normal
  // website booking at a glance.
